...
export default function AboutUsPage() {
  ...
  return (
    <Box sx={{ position: "relative", minHeight: "100vh", overflow: "hidden" }}>
      {/* Background Image with Blur - KEEPING AS REQUESTED */}
      <Box
        sx={{
          position: "absolute",
          inset: 0,
      ...
      <Box sx={{ color: "white", position: "relative" }}>
        ...
        >
          <Container maxWidth="lg">
            <RestaurantIcon sx={{ fontSize: { xs: 35, sm: 45, md: 50 }, mb: 2, color: "black" }} />
            <Typography 
        ...
        <Container maxWidth="lg" sx={{ py: { xs: 4, md: 6 } }}>
          <Stack spacing={{ xs: 3, md: 4 }} alignItems="center">
            <Card 
              sx={{ 
                ...
                "&:hover": {
                  ...
                  boxShadow: "0 8px 32px rgba(255, 61, 0, 0.2)",
                }
              }}
            >
              <CardContent sx={{ p: { xs: 2.5, sm: 3, md: 4 } }}>
                <Stack direction="row" alignItems="center" spacing={2} sx={{ mb: 2 }}>
                  <RestaurantIcon sx={{ color: "#ff3d00", fontSize: { xs: 24, md: 28 } }} />
                  <Typography variant={isMobile ? "h5" : "h4"} color="#ff3d00" fontWeight={700}>
                    Our Mission
                  </Typography>
                </Stack>
                <Typography 
            ...
            >
              <CardContent sx={{ p: { xs: 2.5, sm: 3, md: 4 } }}>
                <Stack direction="row" alignItems="center" spacing={2} sx={{ mb: 2 }}>
                  <VisibilityIcon sx={{ color: "#ff3d00", fontSize: { xs: 24, md: 28 } }} />
                  <Typography variant={isMobile ? "h5" : "h4"} color="#ff3d00" fontWeight={700}>
                    Our Vision
                  </Typography>
                </Stack>
            ...
            >
              <Stack spacing={{ xs: 2.5, md: 3 }} textAlign={{ xs: "center", md: "left" }}>
                <Stack direction="row" alignItems="center" spacing={2} justifyContent={{ xs: "center", md: "flex-start" }}>
                  <GroupIcon sx={{ color: "#ff3d00", fontSize: { xs: 28, md: 32 } }} />
                  <Typography variant={isMobile ? "h4" : "h3"} color="#ff3d00" fontWeight={800}>
                    Who We Are
                  </Typography>
                </Stack>
                ...
                >
                  ...
                  perfectly balance taste, health, and happiness. Every dish tells a story, and we're here to make 
                  sure that story reaches your table fresh and delicious.
                </Typography>
                  ...
                  <Button
                    ...
                    sx={{
                      ...
                      "&:hover": {
                        ...
                        boxShadow: "0 6px 20px rgba(255, 61, 0, 0.4)",
                      },
              ...
              <Card
                ...
                sx={{
                  ...
                  "&:hover": { 
                    ...
                    boxShadow: "0 12px 32px rgba(255, 61, 0, 0.3)",
                    borderColor: "#ff6333",
                  },
                }}
              >
